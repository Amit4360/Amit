...
console.log(Image);
  return (
    <div className=" flex flex-col h-screen items-center justify-start max-w-full px-2 sm:px-2 lg:w-4/5  lg:mt-10  mx-auto ">
      ...
      <div  className="disNone grid py-10 mb-10 md:grid-cols-2 lg:grid-cols-3 justify-items-center w-full gap-5 lg:mt-[15vh] mt-6" id="disJm">
      {
      ...
      <div  className="disNone grid py-10 mb-10 md:grid-cols-1 lg:grid-cols-1 justify-items-center w-full gap-5 lg:mt-[15vh] mt-6" id="disSec">
      {
          secretary.map((data)=>(
            <Card
             id={data.id}
